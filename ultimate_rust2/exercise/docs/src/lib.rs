...
//! Cucurbita that has culinary and cultural significance but no agreed upon botanical or 
//! scientific meaning. The term pumpkin is sometimes used interchangeably with "squash" or 
//! "winter squash", and is commonly used for cultivars of Cucurbita argyrosperma, Cucurbita ficifolia, 
